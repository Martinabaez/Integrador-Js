...
const createProductTemplate = (product) => {
  const { id, name, bid, fact, cardImg } = product;
  return `
    <div class="product">
    ...
    <div class="product-info">
        ...
        <div class="product-mid">
            ...
            <span>$${bid}</span>
                ...
                data-name='${name}'
                data-bid='${bid}'
                data-img='${cardImg}'>Reservar</button>
            </div>
        </div>
    </div>
</div>`;
...
//Función para cerrar el menú hamburguesa y el overlay cuando se hace scroll
const closeOnScroll = () => {
  if (
...
//Función para cerrar el menú hamburguesa y el overlay cuando se hace click en el overlay
...
const completeBuy = () =>{
  completeCartAction("¿Desea realizar su compra?", "¡Gracias por su compra!")
}
